    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('details') ? 'is-invalid' : '' }}" type="text" name="details" id="details" value="{{ old('details', $product->details) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('instock') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="instock" id="instock" value="1" {{ $product->instock || old('instock', 0) === 1 ? 'checked' : '' }}>
