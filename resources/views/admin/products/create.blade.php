...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('instock') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="instock" value="0">
                    <input class="form-check-input" type="checkbox" name="instock" id="instock" value="1" {{ old('instock', 0) == 1 || old('instock') === null ? 'checked' : '' }}>
                    <label class="form-check-label" for="instock">{{ trans('cruds.product.fields.instock') }}</label>
                </div>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.product.fields.instock_helper') }}</span>
            </div>
            <div class="form-group">
