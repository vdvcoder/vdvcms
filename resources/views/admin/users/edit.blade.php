    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mollie_customer') ? 'is-invalid' : '' }}" type="text" name="mollie_customer" id="mollie_customer" value="{{ old('mollie_customer', $user->mollie_customer) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mollie_mandate') ? 'is-invalid' : '' }}" type="text" name="mollie_mandate" id="mollie_mandate" value="{{ old('mollie_mandate', $user->mollie_mandate) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax_percentage') ? 'is-invalid' : '' }}" type="number" name="tax_percentage" id="tax_percentage" value="{{ old('tax_percentage', $user->tax_percentage) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('trail_ends_at') ? 'is-invalid' : '' }}" type="text" name="trail_ends_at" id="trail_ends_at" value="{{ old('trail_ends_at', $user->trail_ends_at) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('extra_billing_information') ? 'is-invalid' : '' }}" type="text" name="extra_billing_information" id="extra_billing_information" value="{{ old('extra_billing_information', $user->extra_billing_information) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('orders') ? 'is-invalid' : '' }}" name="orders[]" id="orders" multiple>
                    @foreach($orders as $id => $order)
                        <option value="{{ $id }}" {{ (in_array($id, old('orders', [])) || $user->orders->contains($id)) ? 'selected' : '' }}>{{ $order }}</option>
                    @endforeach
                </select>
