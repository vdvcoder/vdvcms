    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.update", [$order->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reference') ? 'is-invalid' : '' }}" type="text" name="reference" id="reference" value="{{ old('reference', $order->reference) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer_data') ? 'is-invalid' : '' }}" type="number" name="customer_data" id="customer_data" value="{{ old('customer_data', $order->customer_data) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shipping_typeid') ? 'is-invalid' : '' }}" type="number" name="shipping_typeid" id="shipping_typeid" value="{{ old('shipping_typeid', $order->shipping_typeid) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shipping_price') ? 'is-invalid' : '' }}" type="number" name="shipping_price" id="shipping_price" value="{{ old('shipping_price', $order->shipping_price) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pait_at') ? 'is-invalid' : '' }}" type="text" name="pait_at" id="pait_at" value="{{ old('pait_at', $order->pait_at) }}">
