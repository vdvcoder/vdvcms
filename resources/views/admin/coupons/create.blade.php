    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.coupons.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('percent_off') ? 'is-invalid' : '' }}" type="number" name="percent_off" id="percent_off" value="{{ old('percent_off', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount_left') ? 'is-invalid' : '' }}" type="number" name="amount_left" id="amount_left" value="{{ old('amount_left', '') }}" step="1">
