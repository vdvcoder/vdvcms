        ...
        @can('content_management_access')
            <li class="c-sidebar-nav-dropdown">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('usp_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.usps.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/usps") || request()->is("admin/usps/*") ? "active" : "" }}">
                                <i class="fa-fw fas fa-bus c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.usp.title') }}
                            </a>
                        </li>
                    @endcan
                </ul>
        ...
        @can('setting_access')
            <li class="c-sidebar-nav-dropdown">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('cm_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.cms.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/cms") || request()->is("admin/cms/*") ? "active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
